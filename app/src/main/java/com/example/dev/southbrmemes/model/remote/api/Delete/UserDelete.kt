 ...
 */
object UserDelete{
    fun delete(activity: Activity, success: (note: Response<ReturnViewModel?>) -> Unit,
        ...
        val call = retrofit.delete(URL.Bearer + SessionManager(activity).getPreferences(SessionManager.TOKEN))
